...
Ext.define('SailPoint.form.MultiSelect', {
    ...
    addRecord : function(combo, recordArr, eventOpts){
        ...
        if (this.selectionsStore.findExact(this.valueField, id) === -1){
            ...
            //IIQETN-4828 :- Encoding displayName to avoid XSS
            if (recordCopy.data && recordCopy.data.displayName) {
                recordCopy.data.displayName = Ext.util.Format.htmlEncode(recordCopy.data.displayName);
            }
