    ...
    constructor : function(config){
       ...
       if (config.isEventsTab) {
        ...
        if (config.showViewAccessRequestLink){
            config.tbar.push('->');
            config.tbar.push('<a style="text-decoration:none" href="'+SailPoint.getRelativeUrl('/identityRequest/identityRequest.jsf#/requests')+'">#{msgs.dash_access_req_link_my_acess_requests}<img style="margin-left:4px" src="'+SailPoint.getRelativeUrl('/images/icons/arrow_right_transparent.png')+'"/></a>' );
        }
