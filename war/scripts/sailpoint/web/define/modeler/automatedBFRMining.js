...
SailPoint.roles.warnInvalid = function() {
    var isValid = SailPoint.roles.validateBFRSelections();
    if(!isValid) {
        Ext.MessageBox.alert('#{msgs.err_validation}', '#{msgs.err_business_role__mining_launch_invalid}');
    }
    return isValid;
};
